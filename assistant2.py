...
client = wolframalpha.Client('6GXUHP-XLEWHU3KAP')

folder = 'C:\\Users\\arya dinu\\Music\\'

engine = pyttsx3.init()
voices = engine.getProperty('voices')

b_music = ['Hypnotized (Akon)', 'Jonas Blue - Mama ft. William Singe']
pygame.mixer.init()
...
class Widget:
    def __init__(self):     
       ...
       root.resizable(0, 0)
       root.iconbitmap(r'D:\\project\\Droid-Robot.ico')
       img = ImageTk.PhotoImage(Image.open(r"D:\\project\\assistant_krn.png"))
       ...
       speak('Hello, I am Your Assistant! What should I do for You?')
       self.compText.set('Hello, I am Your Assistant! What should I do for You?')
    ...
    def clicked(self):
        ...
        if 'open ccleaner' in query:
            ...
            music_folder = 'C:\\Users\\arya dinu\\Videos\\'
            music = ['Hypnotized (Akon)', 'INNA Yalla', 'Jonas Blue - Mama ft. William Singe', 'Papi-JLo']
